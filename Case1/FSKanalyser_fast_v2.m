...
% udjævner de små dft, for at gøre SNR mindre, dette kan gøres da hvert
% bliver delt i x antal gange.

Spektro_opt=ones(cut, round(N_min/2));

for n=1:cut-split
    
    for m=1:split
        Spektro_opt(n)=Spektro_opt(n)*Spektro
    end
end
